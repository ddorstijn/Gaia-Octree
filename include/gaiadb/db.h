...
#define DB_MAX_RECORDS 0xffffffff /* >= # of records in a recno tree. */
     ...
     * will return, so region offsets have to be able to hold differences
     * between arbitrary pointers.
     */
    ...
    struct __db_channel;
    typedef struct __db_channel DB_CHANNEL;
    struct __db_cipher;
    typedef struct __db_cipher DB_CIPHER;
    struct __db_compact;
    typedef struct __db_compact DB_COMPACT;
    struct __db_dbt;
    typedef struct __db_dbt DBT;
    struct __db_distab;
    typedef struct __db_distab DB_DISTAB;
    struct __db_env;
    ...
    typedef struct __db_heap_rid DB_HEAP_RID;
    struct __db_heap_stat;
    typedef struct __db_heap_stat DB_HEAP_STAT;
    struct __db_ilock;
    typedef struct __db_ilock DB_LOCK_ILOCK;
    struct __db_lock_hstat;
    typedef struct __db_lock_hstat DB_LOCK_HSTAT;
    struct __db_lock_pstat;
    typedef struct __db_lock_pstat DB_LOCK_PSTAT;
    ...
    typedef struct __db_mutex_stat DB_MUTEX_STAT;
    struct __db_mutex_t;
    typedef struct __db_mutex_t DB_MUTEX;
    struct __db_mutexmgr;
    typedef struct __db_mutexmgr DB_MUTEXMGR;
    ...
    typedef struct __db_seq_record DB_SEQ_RECORD;
    struct __db_seq_stat;
    typedef struct __db_seq_stat DB_SEQUENCE_STAT;
    struct __db_stream;
    typedef struct __db_stream DB_STREAM;
    struct __db_site;
    typedef struct __db_site DB_SITE;
    struct __db_sequence;
    typedef struct __db_sequence DB_SEQUENCE;
    struct __db_thread_info;
    typedef struct __db_thread_info DB_THREAD_INFO;
    struct __db_txn;
    ...
    typedef struct __db_txn_token DB_TXN_TOKEN;
    struct __db_txnmgr;
...
#define DB_LOCK_YOUNGEST 9 /* Select youngest locker. */
    ...
    {                             /* SHARED */
        ...
        uintmax_t
            st_maxosteals;      /* Maximum number of steals in any partition. */
        ...
        uintmax_t
            st_part_max_nowait;   /* Max partition lock granted without wait. */
        ...
        uintmax_t
            st_nlockers_reused; /* Lockers reallocated from thread info. */
...
#define LOG_DBT_SIZE(dbt)                                                      \
    ...
    struct __db_mpoolfile
    {
        ...
        int(*get) __P((DB_MPOOLFILE*, db_pgno_t*, DB_TXN*, u_int32_t, void*));
...
#define DB_GID_SIZE 128
     ...
     * If a container's transaction touches any slices, its
     * TXN_DETAIL.slice_details has a DB_ENV->slice_cnt sized array in shared
     * memory of these. Entries whose txnid is not TXN_INVALID are active. The
     * slice number is implied by the position in the array.
     */
    struct __db_txn_active_slice
    {
...
#if defined(HAVE_EPOLL_CREATE) && defined(HAVE_EPOLL_CTL) &&                   \
...
#include <winsock2.h>
    ...
    struct __db_sequence
    {
        ...
        int(*get) __P((DB_SEQUENCE*, DB_TXN*, u_int32_t, db_seq_t*, u_int32_t));
        ...
        int(*open) __P((DB_SEQUENCE*, DB_TXN*, DBT*, u_int32_t));
        ...
        int(*stat) __P((DB_SEQUENCE*, DB_SEQUENCE_STAT**, u_int32_t));
...
#define DB_NOINTMP                                                             \
    (-30886)                      /* Sequences not supported in temporary      \
...
#define DB_SURPRISE_KID                                                        \
    (-30890)                     /* Child commit where parent                  \
...
#define DB_ASSOC_CREATE 0x00000002        /* Secondary db populated on open. */
        ...
        int(*associate)
            __P((DB*, DB_TXN*, DB*, int (*)(DB*, const DBT*, const DBT*, DBT*),
                 u_int32_t));
        int(*associate_foreign)
            __P((DB*, DB*, int (*)(DB*, const DBT*, DBT*, const DBT*, int*),
                 u_int32_t));
        int(*close) __P((DB*, u_int32_t));
        int(*compact)
            __P((DB*, DB_TXN*, DBT*, DBT*, DB_COMPACT*, u_int32_t, DBT*));
        ...
        int(*get_alloc) __P((DB*, void* (**)(size_t), void* (**)(void*, size_t),
                             void (**)(void*)));
        ...
        int(*get_bt_compress)
            __P((DB*,
                 int (**)(DB*, const DBT*, const DBT*, const DBT*, const DBT*,
                          DBT*),
        ...
        int(*get_partition_callback)
            __P((DB*, u_int32_t*, u_int32_t (**)(DB*, DBT* key)));
        ...
        int(*open) __P((DB*, DB_TXN*, const char*, const char*, DBTYPE,
                        u_int32_t, int));
        ...
        int(*set_alloc) __P((DB*, void* (*)(size_t), void* (*)(void*, size_t),
                             void (*)(void*)));
        ...
        int(*set_bt_prefix) __P((DB*, size_t (*)(DB*, const DBT*, const DBT*)));
        ...
        int(*set_h_hash) __P((DB*, u_int32_t (*)(DB*, const void*, u_int32_t)));
        ...
        int(*set_partition)
            __P((DB*, u_int32_t, DBT*, u_int32_t (*)(DB*, DBT* key)));
        ...
        int(*dump) __P((DB*, const char*, int (*)(void*, const void*), void*,
                        int, int));
        int(*db_am_remove) __P((DB*, DB_THREAD_INFO*, DB_TXN*, const char*,
                                const char*, u_int32_t));
        int(*db_am_rename) __P((DB*, DB_THREAD_INFO*, DB_TXN*, const char*,
...
#define DB_MULTIPLE_RESERVE_NEXT(pointer, dbt, writedata, writedlen)           \
    do {                                                                       \
        u_int32_t* __p = (u_int32_t*)(pointer);                                \
        u_int32_t __off = ((pointer) == (u_int8_t*)(dbt)->data + (dbt)->ulen - \
                                            sizeof(u_int32_t))                 \
                              ? 0                                              \
                              : __p[1] + __p[2];                               \
...
#define DB_MULTIPLE_KEY_RESERVE_NEXT(pointer, dbt, writekey, writeklen,        \
                                     writedata, writedlen)                     \
    do {                                                                       \
        u_int32_t* __p = (u_int32_t*)(pointer);                                \
        u_int32_t __off = ((pointer) == (u_int8_t*)(dbt)->data + (dbt)->ulen - \
                              ...
                              ? 0                                              \
                              : __p[1] + __p[2];                               \
        if ((u_int8_t*)(dbt)->data + __off + (writeklen) + (writedlen) >       \
            (u_int8_t*)(__p - 4)) {                                            \
            writekey = NULL;                                                   \
            writedata = NULL;                                                  \
        } else {                                                               \
...
#define DB_MULTIPLE_KEY_WRITE_NEXT(pointer, dbt, writekey, writeklen,          \
                                   writedata, writedlen)                       \
    do {                                                                       \
        void *__destk, *__destd;                                               \
        DB_MULTIPLE_KEY_RESERVE_NEXT((pointer), (dbt), __destk, (writeklen),   \
                                     __destd, (writedlen));                    \
        if (__destk == NULL)                                                   \
            pointer = NULL;                                                    \
        else {                                                                 \
...
#define DB_MULTIPLE_RECNO_RESERVE_NEXT(pointer, dbt, recno, writedata,         \
                                       writedlen)                              \
    do {                                                                       \
        u_int32_t* __p = (u_int32_t*)(pointer);                                \
        u_int32_t __off = ((pointer) == (u_int8_t*)(dbt)->data + (dbt)->ulen - \
...
#define DB_MULTIPLE_RECNO_WRITE_NEXT(pointer, dbt, recno, writedata,           \
                                     writedlen)                                \
    do {                                                                       \
        void* __destd;                                                         \
        DB_MULTIPLE_RECNO_RESERVE_NEXT((pointer), (dbt), (recno), __destd,     \
                                       (writedlen));                           \
        if (__destd == NULL)                                                   \
            pointer = NULL;                                                    \
        else if ((writedlen) != 0)                                             \
...
#define DBC_WAS_READ_COMMITTED                                                 \
    0x40000                     /* Cursor holds a read commited lock.          \
                                 */
...
#define DB_REGION_MAGIC_RECOVER 0xeeeccc /* Recovery is running. */
     ...
     * separate structures allows us to easily discard internal information
     * without discarding the user's configuration.
     *
...
#define DB_ENV_NOFLUSH 0x00080000          /* DB_NOFLUSH set */
        ...
        int(*dbrename) __P((DB_ENV*, DB_TXN*, const char*, const char*,
                            const char*, u_int32_t));
        ...
        int(*get_backup_callbacks)
            __P((DB_ENV*, int (**)(DB_ENV*, const char*, const char*, void**),
                 int (**)(DB_ENV*, u_int32_t, u_int32_t, u_int32_t, u_int8_t*,
                          void*),
        ...
        void(*get_errcall)
            __P((DB_ENV*, void (**)(const DB_ENV*, const char*, const char*)));
        ...
        int(*get_isalive)
            __P((DB_ENV*, int (**)(DB_ENV*, pid_t, db_threadid_t, u_int32_t)));
        ...
        int(*get_thread_id_string_fn)
            __P((DB_ENV*, char* (**)(DB_ENV*, pid_t, db_threadid_t, char*)));
        ...
        int(*lock_vec) __P((DB_ENV*, u_int32_t, u_int32_t, DB_LOCKREQ*, int,
                            DB_LOCKREQ**));
        ...
        int(*log_put_record)
            __P((DB_ENV*, DB*, DB_TXN*, DB_LSN*, u_int32_t, u_int32_t,
                 u_int32_t, u_int32_t, DB_LOG_RECSPEC*, ...));
        int(*log_read_record) __P((DB_ENV*, DB**, void*, void*, DB_LOG_RECSPEC*,
                                   u_int32_t, void**));
        ...
        int(*memp_register)
            __P((DB_ENV*, int, int (*)(DB_ENV*, db_pgno_t, void*, DBT*),
                 int (*)(DB_ENV*, db_pgno_t, void*, DBT*)));
        int(*memp_stat)
            __P((DB_ENV*, DB_MPOOL_STAT**, DB_MPOOL_FSTAT***, u_int32_t));
        ...
        int(*rep_set_transport) __P((DB_ENV*, int,
                                     int (*)(DB_ENV*, const DBT*, const DBT*,
                                             const DB_LSN*, int, u_int32_t)));
        int(*rep_set_view)
            __P((DB_ENV*, int (*)(DB_ENV*, const char*, int*, u_int32_t)));
        ...
        int(*repmgr_set_incoming_queue_max)
            __P((DB_ENV*, u_int32_t, u_int32_t));
        int(*repmgr_set_socket)
            __P((DB_ENV*, int (*)(DB_ENV*, DB_REPMGR_SOCKET, int*, u_int32_t)));
        ...
        int(*txn_applied)
            __P((DB_ENV*, DB_TXN_TOKEN*, db_timeout_t, u_int32_t));
    ...
    /*
     * Dispatch structure for recovery, log verification and print routines.
     * Since internal and external routines take different arguments (ENV versus
     * DB_ENV), we need something more elaborate than a single pointer and size.
     * Each size is the number of allocated entries in the corresponding
     * dispatch table, rather than a byte count.
     */
    struct __db_distab
    {
    ...
    struct __db_channel
    {
        ...
        int(*send_request)
            __P((DB_CHANNEL*, DBT*, u_int32_t, DBT*, db_timeout_t, u_int32_t));
...
extern "C"
{
    ...
    int db_env_set_func_ioinfo __P((int (*)(const char*, int, u_int32_t*,
                                            u_int32_t*, u_int32_t*)));
    int db_env_set_func_malloc __P((void* (*)(size_t)));
    int db_env_set_func_file_map __P((int (*)(DB_ENV*, char*, size_t, int,
                                              void**),
                                      int (*)(DB_ENV*, void*)));
    int db_env_set_func_region_map __P((int (*)(DB_ENV*, char*, size_t, int*,
                                                void**),
                                        int (*)(DB_ENV*, void*)));
    int db_env_set_func_pread __P((ssize_t(*)(int, void*, size_t, off_t)));
    int db_env_set_func_pwrite __P((ssize_t(*)(int, const void*, size_t,
                                               off_t)));
